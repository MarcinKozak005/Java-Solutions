public class P39_JavaBitSet {
    public static void main(String[] args) {
        ...
        for(int i=0;i<m;i++){
            ...
            switch (command[0]){
                case "AND":  bt[arg1-1].and(bt[arg2-1]); break;
                case "OR":   bt[arg1-1].or(bt[arg2-1]);  break;
                case "XOR":  bt[arg1-1].xor(bt[arg2-1]); break;
                case "SET":  bt[arg1-1].set(arg2);       break;
                case "FLIP": bt[arg1-1].flip(arg2);      break;
            }
